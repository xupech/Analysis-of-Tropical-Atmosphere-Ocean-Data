...
default.ct.point.pred.train <- predict(default.ct,df_train,type = "class")
confusionMatrix(default.ct.point.pred.train, as.factor(df_train$buoy))
...
#Confusion matrix on test data. deeper
